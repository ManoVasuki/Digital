...
namespace ProjectManagerApi.Tests
{
    ...
    public class ProjectControllerTest
    {
        ...
        public void UpdateProjectTest()
        {
            ...
            project.ProjectName = "DataHub project";
            var result = UpdateProject(project);
            Assert.AreEqual(result, true);

            var updatedProject = GetFirstProject();
            Assert.AreEqual(updatedProject.ProjectName, "DataHub project");
        }
        ...
        private User MockFirstUser()
        {
            User user = new User();
            user.UserId = 0;
            user.FirstName = "ManoVasuki";
            user.LastName = "R J";
            user.EmployeeId = 298474;
        ...
        private Project MockSecondProject()
        {
            Project project = new Project();
            project.ProjectId = 0;
            project.ProjectName = "Ancillary Application";
            project.StartDate = DateTime.Now;
